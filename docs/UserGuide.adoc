...
Returns any persons with the `shopkeeper` tag in the `Retail` group.
// end::find[]
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG] [c/CUSTOMFIEILD_KEY:CUSTOMFIELD_VALUE] [g/GROUP]` +
